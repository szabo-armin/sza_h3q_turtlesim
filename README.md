...
ROS 2 pacage template, to get started, use template by clicking on the Green button labeled [`Use this template`](https://github.com/szabo-armin/sza_h3q_turtlesim/generate) / [`Create new repository`](https://github.com/szabo-armin/sza_h3q_turtlesim/generate). 
...
- `sza_h3q_turtlesim` >> `cool_ros2_package` (the folder was already renamed after `Use this template`)
- `szabo-armin` >> `mycoolusername`
